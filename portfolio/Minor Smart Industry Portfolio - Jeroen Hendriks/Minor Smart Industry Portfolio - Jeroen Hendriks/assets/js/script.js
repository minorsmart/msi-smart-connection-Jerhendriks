$(function () {
  ...
  var shuffleme = (function( $ ) {
    ...
    init = function() {
      ...
      $("#grid .col-md-77").slice(0, 4).show();
      $("#grid .col-md-4").slice(0, 100).show();

      $("#loadMore").on('click', function(e) {
        e.preventDefault();
        $("#grid .col-md-77:hidden")
          .slice(0, 4)
          .fadeIn()
          .each(function() {
        ...
        if($("#grid .col-md-77:hidden").length == 0){
...
if($('#map').length >0 ) {
  ...
  function init() {
      ...
      var myLatlng = new google.maps.LatLng(51.64107897859308, 5.8428245686086395);
      ...
      var addresses = ['Lamperen+28,+5446+PT+Wanroij'];
